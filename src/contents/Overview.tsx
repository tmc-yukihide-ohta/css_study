  ...
  return (
    <div className={styles.overViewPage}>
      <section>
        <h3>CSSの一般的な単位</h3>
        <p>
          現在ではさまざまな大きさのデバイスで、解像度もディスプレイの縦横比も違うため、
          <b>フォントサイズを1つだけに指定するのには限界があります</b>。
        </p>
        <p>
      ...
      <section>
        <h3>絶対単位と相対単位</h3>
        <p>
          CSSで使える単位は、<b>絶対単位と相対単位に分類</b>されます。
        </p>
        <p>
          <b>絶対単位：親要素や他要素のサイズに影響されることなく、指定したサイズそのものを表す単位</b>
        </p>
        <p>
          <b>相対単位：他の要素と比較することで大きさが決まる単位</b>
          <br />
